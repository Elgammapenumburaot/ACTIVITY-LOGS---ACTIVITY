...
function insertAnActivityLog($pdo, $operation, $applicants_id, $first_name, $last_name, $email, $years_of_experience, $specialization, $favorite_ward,
							 $username) {

	$sql = "INSERT INTO activity_logs (operation, applicants_id, first_name, last_name, email, years_of_experience, specialization, favorite_ward, username) 
	VALUES(?,?,?,?,?,?,?,?,?)";

	$stmt = $pdo->prepare($sql);
	$executeQuery = $stmt->execute([$operation, $applicants_id, $first_name, $last_name, $email, $years_of_experience, $specialization, $favorite_ward, $username]);
...
function insertApplicant($pdo, $first_name, $last_name, $email, $years_of_experience, $specialization, $favorite_ward, $added_by) {
	$response = array();
	$sql = "INSERT INTO applicants (first_name,
				...
				years_of_experience,
				specialization,
				favorite_ward, added_by) VALUES(?,?,?,?,?,?,?)";
	$stmt = $pdo->prepare($sql);
	$insertApplicant = $stmt->execute([$first_name, $last_name, $email, $years_of_experience, $specialization, $favorite_ward, $added_by]);
	...
	if ($insertApplicant) {
		...
		$insertAnActivityLog = insertAnActivityLog($pdo, "INSERT", $getApplicantID['applicants_id'], 
			...
			$getApplicantID['email'], $getApplicantID['years_of_experience'], $getApplicantID['specialization'], $getApplicantID['favorite_ward'], 
			$_SESSION['username']);
...
function updateApplicant($pdo, $first_name, $last_name, $email, $years_of_experience, $specialization, $favorite_ward, 
	...
	$sql = "UPDATE applicants
			...
			";
	$stmt = $pdo->prepare($sql);
	$updateApplicant = $stmt->execute([$first_name, $last_name, $email, $years_of_experience, $specialization, $favorite_ward, 
	$last_updated, $last_updated_by, $applicants_id]);
	...
	if ($updateApplicant) {
		...
		$insertAnActivityLog = insertAnActivityLog($pdo, "UPDATE", $getApplicantID['applicants_id'], 
			$getApplicantID['first_name'], $getApplicantID['last_name'], 
			$getApplicantID['email'], $getApplicantID['years_of_experience'], $getApplicantID['specialization'], $getApplicantID['favorite_ward'], $_SESSION['username']);
...
function deleteApplicant($pdo, $applicants_id) {
	...
	$insertAnActivityLog = insertAnActivityLog($pdo, "DELETE", $getApplicantByID['applicants_id'], 
		...
		$getApplicantByID['email'], $getApplicantByID['years_of_experience'], $getApplicantByID['specialization'], $getApplicantByID['favorite_ward'],  $_SESSION['username']);
