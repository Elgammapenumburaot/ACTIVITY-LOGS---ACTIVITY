...
if (isset($_POST['insertApplicantBtn'])) {
	...
	$favorite_ward = trim($_POST['favorite_ward']);

	if (!empty($first_name) && !empty($last_name) && !empty($email) && !empty($years_of_experience) && !empty($specialization) ){
		$insertApplicant = insertApplicant($pdo, $first_name, $last_name, $email, $years_of_experience, $specialization, $favorite_ward, $_SESSION['username']);
...
if (isset($_POST['updateApplicantBtn'])) {
	...
	if (!empty($first_name) && !empty($last_name) && !empty($email) && !empty($years_of_experience) && !empty($specialization) ){
		...
		$updateApplicant = updateApplicant($pdo, $first_name, $last_name, $email, $years_of_experience, $specialization, $favorite_ward, $date, $_SESSION['username'], $_GET['applicants_id']);
